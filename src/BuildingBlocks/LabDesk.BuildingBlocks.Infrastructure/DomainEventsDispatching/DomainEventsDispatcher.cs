using Autofac;
using Autofac.Core;
using LabDesk.BuildingBlocks.Application.Events;
using LabDesk.BuildingBlocks.Application.Outbox;
using LabDesk.BuildingBlocks.Domain;
using LabDesk.BuildingBlocks.Infrastructure.DomainEventsDispatching.Interfaces;
using LabDesk.BuildingBlocks.Infrastructure.Serialization;
using MediatR;
